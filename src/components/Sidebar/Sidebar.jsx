...
function Sidebar({ setCafes }) {
  function addCafe(form) {
    const url =
      "https://matcha-and-keyboard-f549965e60e7.herokuapp.com/api/v1/cafes";
    fetch(url, {
      method: "POST",
      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group mb-3">
            ...
            <input
              name="cafe[address]"
              placeholder="1-chome-11-1 Shibuya, Shibuya City, 150-0002, Tokyo, 150-0002, Tokyo"
            ...
            {criteria.map((criterion) => {
              return (
                <React.Fragment key={criterion}>
                  ...
                  />
                  <label
                    className="btn btn-outline-success btn-outline-custom btn-sm mx-1 mb-1"
                    htmlFor={criterion}
                  >
                    {criterion}
                  </label>
